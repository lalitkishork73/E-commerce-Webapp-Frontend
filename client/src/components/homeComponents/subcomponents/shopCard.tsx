...
const ShopCard = (image: { image: string }) => {
  return (
    <>
      <div className="relative block border sm:border-0 sm:w-[250px] h-auto bg-gradient-to-b from-black to-white/20 hover:bg-gradient-to-t shadow-sm shadow-white rounded-tl-lg rounded-br-lg p-1">
