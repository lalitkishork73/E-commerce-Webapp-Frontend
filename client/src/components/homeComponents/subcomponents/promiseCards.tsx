...
function PromiseCards(items: any) {
  return (
    <>
      <main className="flex flex-col justify-center items-center w-[100%] sm:w-[250px] h-[250px] shadow-sm shadow-white bg-gradient-to-t from-black/40 to-white/20 rounded-bl-xl rounded-tr-xl p-1 hover:bg-gradient-to-b from white/20 ">
